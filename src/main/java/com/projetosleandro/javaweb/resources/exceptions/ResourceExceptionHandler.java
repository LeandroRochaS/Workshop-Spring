package com.projetosleandro.javaweb.resources.exceptions;
...
public class ResourceExceptionHandler {
    ...
    public ResponseEntity<StandartError> resurceNotFound(ResourceNotFoundException e, HttpServletRequest request){
